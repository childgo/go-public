...
SIZE_GeoLite2-City=$(echo  cat $Myfile1_phpPath | wc -c)
SIZE_GeoLite2-ASN=$(echo  cat $Myfile2_phpPath | wc -c)
SIZE_GeoLite2-Country=$(echo  cat $Myfile3_phpPath | wc -c)
SIZE_GeoIP2-ISP=$(echo  cat $Myfile4_phpPath | wc -c)
