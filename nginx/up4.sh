...
SIZE_GeoLite2-City=$(cat $Myfile1_phpPath | wc -c)
SIZE_GeoLite2-ASN=$(cat $Myfile2_phpPath | wc -c)
SIZE_GeoLite2-Country=$(cat $Myfile3_phpPath | wc -c)
SIZE_GeoIP2-ISP=$(cat $Myfile4_phpPath | wc -c)
