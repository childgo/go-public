...
repotrack -a x86_64 -p /home/repolin/public_html/Linux/AlmaLinux9/Nginx_SecureGateway/$REPO $REPO
done
#==============================================
...
repotrack -a x86_64 -p /home/repolin/public_html/Linux/AlmaLinux9/Nginx_SecureGateway/Tools/$REPO $REPO
done
#==============================================
