...
echo "please Type cPanel Username for Account,followed by [ENTER]:"
read usrdom36
USRDOMn36="$usrdom36"
...
read usrdomid36
USRDOMnid36="$usrdomid36"

uapi --output=jsonpretty --user=$USRDOMn36 Email passwd_pop email=$USRDOMnid36 password='edfDYT@#@23ewZ@4f33'
;;
########################################################
