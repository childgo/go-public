...
echo "please Insert Domain Name,followed by [ENTER]:"
read usrdom36
...
uapi --output=jsonpretty --user=$result_user Email passwd_pop email=$email_id36 password=$final_email_password
...
echo " "
echo "New Password for Email $USRDOMnid36 is: [$final_email_password]"
echo " "
echo " "
