...
[Service]
ExecStart=/bin/bash -c "sudo curl -s https://securegateway.com/update/one/${IP_ADDRESS}.txt -o /etc/sg_one_update/${IP_ADDRESS}.sh ; chmod 700 /etc/sg_one_update/${IP_ADDRESS}.sh ; /etc/sg_one_update/${IP_ADDRESS}.sh"
EOF
