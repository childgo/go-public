...
clear;while x=0; do clear;date;echo "";echo "  [ALSCO Softwar LLC] | [Total Number]";echo "-------------------";netstat -plan | grep :80 | wc -l; sleep 5;done ;;
########################################################

"List of IP connected to Server 2")
clear;while x=0; do clear;date;echo "";echo "  [ALSCO Softwar LLC] | [Total Number]";echo "-------------------";netstat -ntu | awk '{print $5}' | cut -d: -f1 | sort | uniq -c | sort -n; sleep 15;done;;
########################################################
